...
let historyList = []; // Liste, um erledigte Aufgaben zu speichern
    ...
    fetch('/todos')
        ...
        .then(todos => {
            todos.forEach(todo => {
                ...
                todoList.appendChild(listItem); // Aufgabe zur Liste hinzufügen
            });
        })
        .catch(error => console.error('Fehler beim Laden der Daten:', error)); // Fehler ausgeben
}
